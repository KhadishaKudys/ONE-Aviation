          ...
          <div className="flight-info">
            ...
            <Container>
              <Row>
                ...
                <Col md="8">
                  <h1 id="flight-locations">
                    {this.state.flight_info.from.name} ✈{" "}
                    {this.state.flight_info.to.name}
                  </h1>
                </Col>
                <Col md="2">
              ...
              <Row id="flight-cards">
                <Col md={9}>
                  <Card id="flight-data">
                    ...
                    <Row>
                      ...
                      <Col>
                        <p>{this.state.flight_info.departure_date}</p>
                      </Col>
                    </Row>
                    <Row>
                      <Col>
                    ...
                    <Row>
                      ...
                      <Col>
                        <p>{this.state.flight_info.arrival_date}</p>
                      </Col>
                    </Row>
                    <Row>
                      <Col>
                ...
                <Col>
                  <Card id="price-info">
                    <Row>
                      <h2>Price: € {parseInt(this.state.flight_info.price)}</h2>
                      <div style={{ height: "20px" }}></div>
                      <p>
                        <b>{this.state.flight_info.available_seats} seats</b>{" "}
                        available
                      </p>
                    </Row>
                  </Card>
